...
local lualine_components = require('utils.lualine.components')
-- [[ Configure plugins ]]
  ...
  { 'folke/which-key.nvim', opts = {} },
  {
    ...
    opts = {
      ...
      on_attach = function(bufnr)
        ...
        -- normal mode
        map('n', '<leader>gj', gs.next_hunk, { desc = 'git stage hunk' })
        map('n', '<leader>gk', gs.prev_hunk, { desc = 'git stage hunk' })
...
-- require additional custom options
...
-- require additional custom keymaps
...
vim.keymap.set('n', '<leader>f', find_project_files, { desc = '[F]ind Files' })
...
vim.defer_fn(function()
  require('nvim-treesitter.configs').setup({
    ...
    ensure_installed = { 'c', 'diff', 'cpp', 'go', 'lua', 'luadoc', 'python', 'rust', 'tsx', 'javascript', 'typescript', 'vimdoc', 'vim', 'bash' },
